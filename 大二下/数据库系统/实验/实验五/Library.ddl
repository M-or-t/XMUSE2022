...
ALTER TABLE patrons ADD CONSTRAINT patrons_pk PRIMARY KEY ( parton_id );
...
CREATE TABLE transactions (
    ...
    patrons_parton_id   NUMBER(7) NOT NULL,
    due_date            DATE
);
...
ALTER TABLE transactions
    ADD CONSTRAINT transactions_patrons_fk FOREIGN KEY ( patrons_parton_id )
        REFERENCES patrons ( parton_id );
